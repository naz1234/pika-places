const CACHE = 'pika-shell-v4-map-location';
const SHELL = ['/', '/index.html', '/styles.css', '/js/app.js', '/js/model.js', '/js/store.js', '/js/sync.js', '/js/map-location.js', '/js/map-autofill.js', '/assets/pika-places-favicon-32.png', '/assets/pika-places-apple-touch-180.png', '/assets/pika-places-192.png', '/assets/pika-places-512.png', '/manifest.webmanifest'];
